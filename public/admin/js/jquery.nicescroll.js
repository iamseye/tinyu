...
//      return self.cancelEvent(e);
    ...
    this.onmousewheel = function(e) {
      ...
      var nw = +(new Date());
      var chk = false;
      if (self.opt.pBOOKINGnativescrolling&&((self.checkarea+600)<nw)) {
...
//          var df = (self.newscrollspeed) ? self.newscrollspeed : dd;
    ...
    this.resizeZoom = function() {
      ...
      var py = self.getScrollTop(); //pBOOKING scrolling position
      self.win.css({
...
// override jQuery scrollTop
  ...
  var _scrollTop = jQuery.fn.scrollTop; // pBOOKING original function
...
// override jQuery scrollLeft
  ...
  var _scrollLeft = jQuery.fn.scrollLeft; // pBOOKING original function
